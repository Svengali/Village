...
const MAX_PHYSICS_VEL_SQ: f32 = MAX_PHYSICS_VEL * MAX_PHYSICS_VEL;
...
impl MainState {
    ...
    pub fn fire_player_shot(&mut self, _ctx: &Context) -> GameResult {
    ...
    pub fn handle_collisions(&mut self, _ctx: &Context) -> GameResult {
